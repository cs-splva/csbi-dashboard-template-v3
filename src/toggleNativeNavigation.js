...
function showPageNavigation(show) {
	var divs = document.getElementsByClassName("sfx_navigation-bar_210");
...
function monitorDivTextChange() {
    const targetDiv = document.querySelector('.sfx_label_936');

    if (!targetDiv) {
        console.error('The div with class "sfx_label_936" does not exist.');
        return;
    }
